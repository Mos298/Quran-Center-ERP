...
namespace النظام_النهائي
{
    public partial class home : UserControl
    {
        ...
        private void lblSupervisorId_Click(object sender, EventArgs e)
        {

        }

        private void lblSupervisorPositionValue_Click(object sender, EventArgs e)
        {

        }

        private void lblSupervisorNameValue_Click(object sender, EventArgs e)
        {
